                                                  ...
                                                  Center(
                                                    child: InkWell(
                                                      onTap: () {
                                                        ...
                                                        Navigator.push(context, MaterialPageRoute(builder: (context) =>  UserReqAdd_(
                                                        id: item.userid,name: item.name,photo: item.photo,category: item.category,direction: item.direction,time: item.time,
                                                        incredient: item.incredient,incredient1: item.incredient1,categoryid: item.categoryid,addedby: item.addedby,recipeid: item.id,recipename: item.name,
                                           ),));
                                                      },
                                                        child: Container(
                                                        height: height/30,
                                                        ...
                                                        child: Text("View more",style: TextStyle(color: white,fontSize: 19,fontWeight:FontWeight.w600 ),),
                                                      ),
                                                    ),
                                                  ),
                                                ],
