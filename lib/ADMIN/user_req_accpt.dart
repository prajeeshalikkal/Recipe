...
class UserReqAdd_ extends StatelessWidget {
  // id kkk user id varnath
  // userid recipe id aan varnath
  String id;
  String name;
  dynamic photo;
  String category;
        ...
        child: Column(
          children: [
            ...
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
              child: Text(
                "m Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries,",
                style: TextStyle(
            ...
            Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: myblack,
                  image: DecorationImage(
                      image: NetworkImage(photo[1]), fit: BoxFit.cover),
                )),
                    ...
                    builder: (context,value,child) {
                      return TextButton(
                        ...
                        onPressed:(){
                         ...
                         value.UserRecipeStatusAccept(id,"APPROVED",context);
                        }, 
                         child: Text("Accept",style: TextStyle(color:acceptbtn,fontSize: 18,fontWeight:FontWeight.w600),));
                    }
                  ),
                  /// textbutton  
                      ...
                      Consumer<mainprovider>(
                        builder: (context,value,child) {
                          return TextButton(
                            style:ButtonStyle(foregroundColor: MaterialStateProperty.all(Colors.white)),
                            onPressed:(){
                            value.UserRecipeStatusAccept(id,"REJECTED",context);
                               }, 
                                child: Text("Recject",style: TextStyle(color:orange,fontSize: 18,fontWeight:FontWeight.w600),));
                        }
                      ),
