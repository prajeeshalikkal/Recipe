      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            SizedBox(height: height / 60),
            Consumer<mainprovider>(builder: (context, val, child) {
              return txtformfield2(
                "Write Username",
                val.nameregcontroller,
              );
            }),
            ...
            Consumer<mainprovider>(builder: (context, val, child) {
              return InkWell(
                  onTap: () {
                    ...
                    print("loloooooo" + userid.toString());
                    val.EditProfile(
                      userid,
                      phone,
                      context
          ...
          return Wrap(
            children: <Widget>[
              ListTile(
                  ...
                  onTap: () => {
                        Mainprovider.getEditProfileImgcamera(),
                        Navigator.pop(context)
                      }),
              ListTile(
                  ...
                  onTap: () => {
                        Mainprovider.getEditProfileImggallery(),
                        Navigator.pop(context)
                      }),
            ],
          );
